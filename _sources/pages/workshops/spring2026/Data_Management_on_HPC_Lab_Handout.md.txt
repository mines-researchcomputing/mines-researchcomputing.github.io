...
```bash
cd $SCRATCH
tar -czf workshop_spr2026.tar.gz jobs
```
...
cd new_data_folder
cp ../workshop_spr2026.tar.gz 
tar -xf workshop_spr2026.tar.gz 
```
...
```bash
scp username@wendian.mines.edu:~/scratch/workshop_spr2026.tar.gz .
```
